...
cd $DEPLOY_DIR
./run.sh push aliyun-docker mongo-admin.hiii-life.com:prod ./docker/mongo-admin.hiii-life.com

say_progress_begin "更新部署配置"
kubectl apply -f etc/mongo-admin.hiii-life.com/kubernetes/prod.yml
